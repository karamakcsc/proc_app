...
fixtures = [
	...
	# then 92 previously-untranslated field labels/Select options) --
	...
	{"dt": "Translation", "filters": [
		["language", "=", "ar"],
		["source_text", "in", ["% Amount Billed", "Accepted Qty in Stock UOM", "Account Currency (From)", "Account Currency (To)", "Accounting Details", "Acknowledged by Supplier", "Add Serial / Batch No", "Add Serial / Batch No (Rejected Qty)", "Advance Paid (Company Currency)", "Advance Taxes and Charges", "Advances", "Alias", "Allow purchase invoice creation without purchase order", "Allow purchase invoice creation without purchase receipt", "Allowed to transact with", "Amendment Type", "Amount", "Approved", "Auto create assets on purchase", "Auto Renew", "Bank Account No", "Budget Impact", "Commercial Registration No.", "Comparison Items", "Concerned Department", "Consultancy", "Contract Category", "Contract Value", "Date Change", "Deferred Expense Account", "Department Manager", "Department Officer", "Description of Change", "Disable Rounded Total", "Dispute Type", "Draft", "Duplicate Invoice", "Exchange Rate", "FIFO", "Generated By", "Generated On", "Hosting", "Internal Supplier Details", "Inventory Valuation", "Is Paid", "Item Addition or Removal", "Item Attributes", "Lead Time Weight (%)", "LIFO", "Missing Items", "MPS", "Onboarding Reviewed By", "Onboarding Submitted On", "Paid From Account Type", "Paid To Account Type", "Party User", "Per-Company Accounts", "Portal Onboarding Status", "Price Change", "Price Weight (%)", "Prices HTML", "Primary Address Preview", "Printing Details", "Purchase Order Amendment", "Quantity Change", "References", "Renewed From", "Requested By", "Requesting Department", "Resolution Note", "RFQ Comparison Sheet", "Rounded Total (Company Currency)", "Select Dispatch Address", "Selection Finalized By", "Selection Finalized On", "Serial Nos / Batches", "Shipment/Tracking Reference", "Shipped", "Signee", "SLA", "Source Material Request", "Stock Levels HTML", "Submitted On", "Supplier Acknowledged On", "Supplier Acknowledgment Note", "Supplier ASN", "Supplier Invoice Dispute", "Tax Identification", "Tax Issue", "Terminated By", "Termination Date", "Termination Reason", "Terms", "Total Taxes and Charges", "Totals (Company Currency)", "Under Review", "UOM Conversion Details", "Wrong Amount"]],
		["contributed", "=", 0],
	]},
]
