...
| 2 — Purchase Requisition & Approval Workflow | 🟡 In Progress — built and department-scoped (inactive, not yet tested). See Section 3. | Configure Material Request + Frappe Workflow |
